...
class MoisturizerScreen extends StatelessWidget {
  const MoisturizerScreen({Key? key}) : super(key: key);
                ...
                itemBuilder: (context, index) => GestureDetector(
                    onTap: () {
                      Provider.of<ProductsProvider>(context, listen: false)
                          .findIndex(Provider.of<ProductsProvider>(context,
                                  listen: false)
                              .moisturizerData[index]
                              .id);
                      Get.to(
                          ProductDetailScreen(Provider.of<ProductsProvider>(
                                  context,
                                  listen: false)
                              .moisturizerData[index]
                              .id),
                              ...
                              Row(
                                children: [
                                  Padding(
                                    ...
                                    child: Text(
                                      '${Provider.of<ProductsProvider>(context).moisturizerData[index].size}g',
                                      style: const TextStyle(
                                          overflow: TextOverflow.ellipsis,
                                  ...
                                  Padding(
                                    padding: const EdgeInsets.only(left: 8.0),
                                    child: Text(
                                      '- ₹ ${Provider.of<ProductsProvider>(context).moisturizerData[index].price}',
                                      style: const TextStyle(
                                          overflow: TextOverflow.ellipsis,
                                          color: mainColor,
                                          fontSize: 20,
