        ...
        children: [
          ...
          Expanded(
            child: GridView.builder(
                ...
                itemCount:
                    Provider.of<ProductsProvider>(context).womenData.length,
                              ...
                              Row(
                                children: [
                                  Padding(
                                    ...
                                    child: Text(
                                      '${Provider.of<ProductsProvider>(context).womenData[index].size}g',
                                      style: const TextStyle(
                                          overflow: TextOverflow.ellipsis,
                                  ...
                                  Padding(
                                    padding: const EdgeInsets.only(left: 8.0),
                                    child: Text(
                                      '- ₹ ${Provider.of<ProductsProvider>(context).womenData[index].price}',
                                      style: const TextStyle(
                                          overflow: TextOverflow.ellipsis,
                                          color: mainColor,
                                          fontSize: 20,
